...
Azure AI 파운드리의 음성 플레이그라운드에서 *실시간 음성 텍스트 변환*을 사용해 보. 

1. *음성* 페이지에서 아래로 스크롤하여 *음성 기능 사용해 보기*에서 **실시간 음성 텍스트 변환**을 선택합니다. *음성 플레이그라운드*로 이동합니다. 
...
이 연습에서는 Azure AI 파운드리의 음성 플레이그라운드에서 Azure AI 음성 서비스를 사용해 보았습니다. 그런 다음 실시간 음성 텍스트 변환 서비스를 사용하여 오디오 녹음을 텍스트로 변환했습니다. 오디오 파일이 재생되면서 텍스트 대화 기록이 생성되는 것을 볼 수 있었습니다.
